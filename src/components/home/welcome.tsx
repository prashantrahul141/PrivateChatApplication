      ...
      <div className='flex h-screen w-screen items-center justify-center '>
        <div className='h-max w-full max-w-xl text-center'>
          ...
          <div className='mt-24 flex items-center justify-center '>
            <Link href='/signin'>
              <button className='btn-signin h-max w-max px-3 font-ubuntu text-sm capitalize'>
                Sign up for free
              </button>
            </Link>
            <Link href={'/about'}>
              <button className='btn-signin h-max w-max border border-themePrimary-300 bg-transparent  px-3 font-ubuntu text-sm  capitalize hover:bg-themePrimary-300/10'>
                Learn More
              </button>
            </Link>
          </div>
